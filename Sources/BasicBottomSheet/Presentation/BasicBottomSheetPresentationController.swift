//
//  BasicBottomSheetPresentationController.swift
//  
//
...
public final class BasicBottomSheetPresentationController: UIPresentationController {
  ...
  private var presentable: BasicBottomSheetPresentable? {
    presentedViewController as? BasicBottomSheetPresentable
  }
  ...
  private lazy var bottomSheetContainerView = BasicBottomSheetContainerView(
  ...
  private lazy var handleView: UIView = {
    ...
    view.layer.cornerRadius = BasicBottomSheetHandleMetric.size.height * 0.5
    return view
  }()
  ...
  public override var frameOfPresentedViewInContainerView: CGRect {
    ...
    let adjustedSize = CGSize(
      ...
      height: containerViewFrame.size.height - topYPosition
    )
  ...
  private var bottomSheetTopInset: CGFloat = 0.0
...
extension BasicBottomSheetPresentationController {
  ...
  func performLayout(animated: Bool) {
    if animated {
      BasicBottomSheetAnimator.animate({ [weak self] in
  ...
  private func adjustHandleViewFrame() {
    handleView.frame.origin.y = BasicBottomSheetHandleMetric.verticalMargin
    handleView.frame.size = BasicBottomSheetHandleMetric.size
    handleView.center.x = CGRectGetMidX(bottomSheetContainerView.bounds)
  }

  private func adjustPresentedViewControllerTopInset() {
    let topInset = handleView.frame.maxY + BasicBottomSheetHandleMetric.verticalMargin
  ...
  private func configureViewLayout() {
    guard let viewControllable = presentedViewController as? BasicBottomSheet
    else { return }

    topYPosition = viewControllable.topYPosition
    bottomSheetTopInset = viewControllable.bottomSheetTopInset
  }
...
extension BasicBottomSheetPresentationController: UIGestureRecognizerDelegate {
